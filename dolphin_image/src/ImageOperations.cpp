...
void ImageOperations::insertCubeInImage(
    const Image3D& cube,
...
void ImageOperations::addCubeToImage(
    const Image3D& cube,
    Image3D& image
) {
    // Use PasteImageFilter to paste the extracted region into the target image
...
void ImageOperations::removePadding(Image3D& image, const Padding& padding) {
...
void ImageOperations::cropToOriginalSize(Image3D& image, const CuboidShape& originalSize) {
...
void ImageOperations::normalizeChannel(Image3D& image){
