...
TEST_F(PaddingTest, MirrorPadding) {
    ...
    Image3D padded = img;
    ImagePadding::padImage(padded, padding, PaddingFillType::MIRROR);
...
TEST_F(PaddingTest, LinearPadding) {
    ...
    Image3D padded = img;
    ImagePadding::padImage(padded, padding, PaddingFillType::LINEAR);
...
TEST_F(PaddingTest, QuadraticPadding) {
    auto padding = makePadding(2, 2, 2);
    Image3D padded = img;
    ImagePadding::padImage(padded, padding, PaddingFillType::QUADRATIC);
    EXPECT_EQ(padded.getShape(), CuboidShape(12, 12, 12));
}
...
TEST_F(PaddingTest, SinusoidPadding) {
    auto padding = makePadding(2, 2, 2);
    Image3D padded = img;
    ImagePadding::padImage(padded, padding, PaddingFillType::SINUSOID);
    EXPECT_EQ(padded.getShape(), CuboidShape(12, 12, 12));
}
...
TEST_F(PaddingTest, GaussianPadding) {
    auto padding = makePadding(2, 2, 2);
    Image3D padded = img;
    ImagePadding::padImage(padded, padding, PaddingFillType::GAUSSIAN);
    EXPECT_EQ(padded.getShape(), CuboidShape(12, 12, 12));
}
...
TEST_F(PaddingTest, PadToShape) {
    Image3D padded = img;
    auto padding = ImagePadding::padToShape(padded, CuboidShape(16, 16, 16), PaddingFillType::ZERO);
    EXPECT_EQ(padded.getShape(), CuboidShape(16, 16, 16));
}

TEST_F(PaddingTest, ExpandToMinSize) {
    Image3D small(CuboidShape(4, 4, 4), 1.0f);
    ImagePadding::expandToMinSize(small, CuboidShape(16, 16, 16));
