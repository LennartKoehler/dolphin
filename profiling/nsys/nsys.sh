...
# sudo /usr/local/cuda-13.0/bin/nsys profile   --trace cuda,osrt,nvtx   --gpu-metrics-devices=all   --cuda-memory-usage true   --force-overwrite true   --output "$SCRIPT_DIR/$OUTNAME" ./dolphin deconvolution -c ../configs/default_config.json