...
// void LabeledDeconvolutionStrategy::setLabeledImage(const std::string& labelImagePath) {
//     this->labelImageReader = labelImagePath;
// }
...
// std::set<int> getUniqueLabels(const Image3D& image, const BoxCoord& roi){
...
// std::vector<Label> LabeledDeconvolutionStrategy::getLabelGroups(int channelNumber, const BoxCoord& roi, std::vector<std::shared_ptr<PSF>>& psfs, const Image3D& image) {
