...
void GibsonLanniPSFConfig::registerAllParameters(){
    ...
    getParameters().push_back({ParameterType::Float, &ti0_nm, "ti0_nm", false, "workingDistanceDesign_nm", "--ti0_nm", "Working distance design", false, true, 0.0, 20000.0, nullptr});
    getParameters().push_back({ParameterType::Float, &ti_nm, "ti_nm", false, "workingDistanceExperimental_nm", "--ti_nm", "Working distance experimental", false, true, 0.0, 20000.0, nullptr});
    ...
    getParameters().push_back({ParameterType::Float, &tg0_nm, "tg0_nm", false, "coverslipThicknessDesign_nm", "--tg0_nm", "Coverslip thickness design", false, true, 0.0, 5000.0, nullptr});
    getParameters().push_back({ParameterType::Float, &tg_nm, "tg_nm", false, "coverslipThicknessExperimental_nm", "--tg_nm", "Coverslip thickness experimental", false, true, 0.0, 5000.0, nullptr});
    ...
    getParameters().push_back({ParameterType::Float, &pixelSizeAxial_nm, "pixelSizeAxial_nm", false, "pixelSizeAxial_nm", "--pixelSizeAxial_nm", "Pixel size axial", false, true, 1.0, 1000.0, nullptr});
    getParameters().push_back({ParameterType::Float, &pixelSizeLateral_nm, "pixelSizeLateral_nm", false, "pixelSizeLateral_nm", "--pixelSizeLateral_nm", "Pixel size lateral", false, true, 1.0, 1000.0, nullptr});
