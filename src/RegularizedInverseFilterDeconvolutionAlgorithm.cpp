...
Hyperstack RegularizedInverseFilterDeconvolutionAlgorithm::deconvolve(Hyperstack& data, PSF& psf) {
    ...
    for (auto& channel : data.channels) {
        ...
        for(auto& gridImage : this->gridImages){
            ...
            // H*H
            UtlFFT::complexMultiplication(this->paddedH, this->paddedH, H2, this->cubeVolume);
            // Laplacian L
            UtlFFT::calculateLaplacianOfPSF(this->paddedH, L, this->cubeWidth, this->cubeHeight, this->cubeDepth);
            ...
            UtlFFT::complexDivisionStabilized(this->paddedH, FA, FP, this->cubeVolume, this->epsilon);
