...
namespace CUBE_MAT {
    ...
    cudaError_t complexElementwiseMatMulFftwComplex(int Nx, int Ny, int Nz, fftw_complex* A, fftw_complex* B, fftw_complex* C, cudaStream_t stream = 0);
    ...
    cudaError_t complexElementwiseMatMulConjugateFftwComplex(int Nx, int Ny, int Nz, fftw_complex* A, fftw_complex* B, fftw_complex* C, cudaStream_t stream = 0);
    ...
    cudaError_t complexElementwiseMatDivFftwComplex(int Nx, int Ny, int Nz, fftw_complex* A, fftw_complex* B, fftw_complex* C, double epsilon, cudaStream_t stream = 0);
    ...
    cudaError_t complexElementwiseMatDivStabilizedFftwComplex(int Nx, int Ny, int Nz, fftw_complex* A, fftw_complex* B, fftw_complex* C, double epsilon, cudaStream_t stream = 0);
}
...
namespace CUBE_REG {
    ...
    cudaError_t calculateLaplacianFftwComplex(int Nx, int Ny, int Nz, fftw_complex* psf, fftw_complex* laplacian_fft, cudaStream_t stream = 0);
    cudaError_t gradXFftwComplex(int Nx, int Ny, int Nz, fftw_complex* image, fftw_complex* gradX, cudaStream_t stream = 0);
    cudaError_t gradYFftwComplex(int Nx, int Ny, int Nz, fftw_complex* image, fftw_complex* gradY, cudaStream_t stream = 0);
    cudaError_t gradZFftwComplex(int Nx, int Ny, int Nz, fftw_complex* image, fftw_complex* gradZ, cudaStream_t stream = 0);
    cudaError_t computeTVFftwComplex(int Nx, int Ny, int Nz, double lambda, fftw_complex *gx, fftw_complex *gy, fftw_complex *gz, fftw_complex *tv, cudaStream_t stream = 0);
    cudaError_t normalizeTVFftwComplex(int Nx, int Ny, int Nz, fftw_complex* gradX, fftw_complex* gradY, fftw_complex* gradZ, double epsilon, cudaStream_t stream = 0);
}
...
namespace CUBE_FTT {
    ...
    cudaError_t octantFourierShiftFftwComplex(int Nx, int Ny, int Nz, fftw_complex* data, cudaStream_t stream = 0);
    ...
    cudaError_t normalizeFftwComplexData(int Nx, int Ny, int Nz, fftw_complex* d_data, cudaStream_t stream = 0);
}
